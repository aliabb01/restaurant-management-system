...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 189px;" src="images/logo2.png" alt="" width="189" /></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h3 class="size-30" style="Margin-top: 0;Margin-bottom: 12px;font-style: normal;font-weight: normal;color: #281557;font-size: 26px;line-height: 34px;font-family: sans-serif;text-align: center;" lang="x-size-30"><span class="font-sans-serif"><strong><span style="color:#fff">La Cozzza Infuriata</span></strong></span></h3>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;line-height: 20px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30"><span style="color:#000000">Hello</span></p>
      </div>
    </div>
        
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"><span style="color:#000000">Your purchase has successfully finished.&nbsp;</span><font color="#000000">Thank you for your order. Enjoy 15% off your next order with the code RETURN15</font></p><p class="size-20" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"><span style="color:#281557">To download your receipt/invoice click on the </span><span style="color:#e31212">button</span><span style="color:#281557"> below</span></p>
      </div>
    </div>
      ...
      <div class="btn fullwidth btn--shadow btn--large" style="text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #e31212;font-family: Lato, Tahoma, sans-serif;" href="http://127.0.0.1:8000/invoice">Download Your Invoice</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://apollonrailway.com/invoice" style="width:560px" arcsize="9%" fillcolor="#E31212" stroke="f"><v:shadow on="t" color="#B60E0E" offset="0,2px"></v:shadow><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,10px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Lato,Tahoma,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Download Your Ticket</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
      ...
      <div class="btn btn--shadow btn--medium" style="Margin-bottom: 20px;text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 12px;font-weight: bold;line-height: 22px;padding: 10px 20px 11px 20px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #e31212 !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #fff;font-family: sans-serif;" href="http://localhost:8000/welcome">Back to the site</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://apollonrailway.com/welcome" style="width:129px" arcsize="10%" fillcolor="#FFFFFF" stroke="f"><v:shadow on="t" color="#CCCCCC" offset="0,2px"></v:shadow><v:textbox style="mso-fit-shape-to-text:t" inset="0px,9px,0px,8px"><center style="font-size:12px;line-height:22px;color:#E31212;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Back to the site</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
            ...
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <div style="font-size: 12px;line-height: 19px;">
                  <div>La Cozzza Infuriata,<br />
Lithuania, Kaunas, 51369.</div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>You are receiving this email because you ordered from La Cozzza Infuriata&nbsp;</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
